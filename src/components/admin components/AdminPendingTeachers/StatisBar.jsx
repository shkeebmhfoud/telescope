...
const StatisBar = (
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-sm p-6 border-r-yellow-700 border-r-4">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-r-red-700 border-r-4">
                <div className="flex items-center">
