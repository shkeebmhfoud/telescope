...
import { FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiStar, FiBookOpen } from 'react-icons/fi';
...
const TeacherLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      toast.success('مرحباً بك أستاذ محمد! تم تسجيل الدخول بنجاح');
      setIsLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-green-50 via-white to-emerald-100">
        <div className="absolute top-0 left-0 w-full h-full opacity-20">
          ...
          <div className="absolute top-40 right-20 w-96 h-96 bg-green-600 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
          <div className="absolute -bottom-8 left-40 w-80 h-80 bg-teal-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-4000"></div>
        </div>
          ...
          <div className="relative bg-gradient-to-r from-emerald-600 to-green-700 p-8 text-white text-center">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center justify-center space-x-2 space-x-reverse mb-4">
                ...
                <h2 className="text-2xl font-bold">بوابة المعلمين</h2>
              </div>
              <p className="text-emerald-100 text-sm">ادخل إلى لوحة التحكم الخاصة بك</p>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                      <FiMail className="h-5 w-5 text-gray-400 group-focus-within:text-emerald-600 transition-colors" />
                    </div>
                    <input
                      type="email"
                      name="email"
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="h-4 w-4 text-emerald-600 focus:ring-emerald-600 border-gray-300 rounded transition-colors"
                  />
              ...
              <div className="pt-4">
                <button
                  ...
                  className={`w-full relative overflow-hidden py-4 px-6 rounded-xl font-bold text-white transition-all duration-300 transform hover:scale-[1.02] focus:scale-[1.02] shadow-lg hover:shadow-xl ${isLoading
                    ...
                    : 'bg-gradient-to-r from-emerald-600 to-green-700 hover:from-green-700 hover:to-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-600'
                    }`}
                >
